;(function () {
	...
	var clickMenu = function() {
		$('#fh5co-offcanvass a, #fh5co-footer a, .thumb_img a').click(function(){
			var section = $(this).data('nav-section')
		    $('html, body').animate({
		        scrollTop: $('[data-section="' + section + '"]').offset().top
		    }, 500);
				//ナビメニューをクリックしたらすべて表示
				$('#fh5co-features .to-animate, #fh5co-features-2 .to-animate').addClass('fadeIn animated');
				return false;
		});
	};
	...
	var featuresAnimate = function() {
		if ( $('#fh5co-features').length > 0 ) {
				...
				//スクロールだったらアニメーションでフェードイン
				$('#fh5co-features .to-animate').each(function( k ) {
					console.log("scroll anime");
					var el = $(this);
					setTimeout ( function () {
